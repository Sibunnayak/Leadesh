  ...
  return (
    <div className="bg-black flex items-center justify-center font-sans text-white">
      <div className="text-center">
        <div className="lg:text-8xl lg:mb-12 lg:mt-24 text-5xl max-sm:text-2xl mb-8 mt-14">
          ...
          <div>
            <span className="rounded-anim-two ping absolute left-[71%] lg:mt-0 mt-33 max-sm:mt-7"></span>
          </div>
        </div>
        <div className="my-12 text-xl w-3/4 mx-auto">
          Leadesh empowers you to select keywords that matter to your business
          or interests, and instantly alerts you when those words appear in your
          WhatsApp conversations. Stay connected, engage with the right people,
          and turn every chat into a potential sales opportunity.
        </div>
        <div className="my-8">
